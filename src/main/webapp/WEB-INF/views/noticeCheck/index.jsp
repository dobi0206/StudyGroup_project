  ...
  <form id = "noticeForm">
    <div id = "container">
      <div id = 'noticeAdmin'>
        ...
        <br>
        <div class="form-floating">
          <input type="text" class="form-control" id="title" name = "title" placeholder="제목" maxlength="10" value="${notice.title}" readonly style="background-color:#e0e0e0">
          <label for="floatingInput">제목</label>
        </div>
        <br>
        <div class="form-floating">
          <input type="text" class="form-control" id="content" name="Content" placeholder="내용" maxlength="60" value="${notice.content}" readonly style="background-color:#e0e0e0">
        ...
        <button class="btn btn-outline-primary me-2" type="button" id ="buttonUpdate">수정</button>
        <button class="btn btn-outline-primary me-2" type="button" id ="buttonDelete">삭제</button>
        </c:if>
